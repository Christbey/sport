<div class="relative" x-data="{ open: false }">
    <button @click="open = !open"
            type="button"
            class="flex mx-3 px-3 text-sm bg-gray-200 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 ">
    ...
    <div x-show="open"
         ...
         class="absolute right-0 z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow  rounded-xl">
