            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 items-center sm:-my-px sm:ms-10 sm:flex">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button type="button"
                                    class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                {{ __('Pickem') }}
                                <svg class="ms-2 -me-0.5 h-4 w-4 inline-block" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <x-slot name="content">
                            <div class="w-60">
                                ...
                                <x-dropdown-link
                                        href="{{ route('nfl.stats.index') }}">{{ __('NFL Stats') }}</x-dropdown-link>
                                <x-dropdown-link
                                ...
                                <x-dropdown-link href="{{ route('covers.games') }}">
                                    {{ __('Covers Games') }}
                                </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('nfl.stats.index') }}"
                                   :active="request()->routeIs('nfl.stats.index')">{{ __('NFL Stats') }}</x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('team_rankings.scoring') }}"
                                   :active="request()->routeIs('team_rankings.scoring')">
                {{ __('Stats Ranking') }}
