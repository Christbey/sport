...
<x-dropdown-link href="{{route('team_rankings.scoring')}}" >{{__('Offense Defense')}}</x-dropdown-link>
                                <x-dropdown-link href="{{route('team_rankings.rankings')}}" >{{__('Team Rankings')}}</x-dropdown-link>
                            </div>
                        </x-slot>
                    </x-dropdown>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('team_rankings.scoring') }}" :active="request()->routeIs('team_rankings.scoring')">
                {{ __('Stats Ranking') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('team_rankings.rankings') }}" :active="request()->routeIs('team_rankings.rankings')">
                {{ __('Team Rankings') }}
            </x-responsive-nav-link>
        </div>
